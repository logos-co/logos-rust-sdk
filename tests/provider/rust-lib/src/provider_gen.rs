// @generated by: logos-lidl-gen sdk_test_provider_module.lidl --provider --protocol-version 0.1.0 -o src/provider_gen.rs
// Checked in: the C-ABI LIDL frontend cannot link into a host build-dependency
// under nixpkgs, so this scaffold is generated out-of-process and committed.
// Regenerate with the command above if sdk_test_provider_module.lidl changes.
...
pub trait SdkTestProviderModule: Send + 'static {
...
pub extern "C" fn logos_module_get_methods() -> *mut c_char {
    to_c_string("[{\"isInvokable\":true,\"name\":\"add\",\"parameters\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"returnType\":\"int\",\"signature\":\"add(int,int)\"}]".to_string())
}

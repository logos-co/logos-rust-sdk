// @generated by: logos-lidl-gen sdk_test_caller_module.lidl --provider --protocol-version 0.1.0 -o src/provider_gen.rs
...
// Regenerate with the command above if sdk_test_caller_module.lidl changes.
...
pub trait SdkTestCallerModule: Send + 'static {
...
pub extern "C" fn logos_module_get_methods() -> *mut c_char {
    to_c_string("[{\"isInvokable\":true,\"name\":\"call_add\",\"parameters\":[{\"name\":\"a\",\"type\":\"int\"},{\"name\":\"b\",\"type\":\"int\"}],\"returnType\":\"int\",\"signature\":\"call_add(int,int)\"}]".to_string())
}
